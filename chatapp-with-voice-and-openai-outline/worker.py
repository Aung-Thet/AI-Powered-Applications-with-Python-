...
def openai_process_message(user_message):
    ...
    openai_response = openai_client.chat.completions.create(
        model="gpt-5-nano", # Note: Changed from "gpt-5-nano" as standard OpenAI currently uses gpt-3.5-turbo, gpt-4, or gpt-4o. Change back if using a custom local alias.
        messages=[
